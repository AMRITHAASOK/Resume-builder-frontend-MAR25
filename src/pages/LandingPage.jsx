        ...
        <div>
            <section id='bg1'>
                <div className="row pt-5">
                    ...
                    <div className="col-4 box py-5 border rounded mt-5 text-center ">
            ...
            <section className='p-5'>
                ...
                <div className="row">
                    ...
                    <div className="col-6">
                        <img src="https://cdn-images.zety.com/images/zety/landings/builder/resume-builder-jumbotron-image@3x.png" width={'500px'} height={'500px'} alt="" />
                    </div>
                </div>
            </section>
            <section id='bg2'>
                ...
                <div className="row p-5">
                    ...
                    <div className="col-6">
                        ...
                        <p>
                            ...
                            — Based on a survey of 258 users.
                        </p>
                        <p>
